...
sq_RunScript("arrangement/onstartdungeon.nut");
sq_RunScript("arrangement/onstartmap.nut");
sq_RunScript("arrangement/resetdungeonstart.nut");
sq_RunScript("arrangement/procappend.nut");
